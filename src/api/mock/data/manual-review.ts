...
export const mockReviewCases: ManualReviewCase[] = [
  ...
  //         'Government data mismatch on address field',
  //       ],
  //       riskScore: 42,
  //       recommendation: 'proceed',
  //       confidence: 0.88,
  //       evidence: [
  //         { type: 'positive', description: 'Identity verified successfully via government records' },
  ...
  //         { type: 'positive', description: 'Employment verified with official records' },
  //       ],
  //       pastOutcomes: {
  //         totalCases: 156,
  //         cleared: 148,
  ...
  //         watchlist: 'Clear',
  //       },
  //       documentImageUrl: 'https://picsum.photos/seed/mr004doc/300/200',
  //       selfieImageUrl: 'https://picsum.photos/seed/mr004self/200/200',
  //       status: 'pending',
  //   },
  //   {
  //   id: 'MR-002',
  ...
  //     watchlist: 'Clear',
  //   },
  //   documentImageUrl: 'https://picsum.photos/seed/mr002doc/300/200',
  //   selfieImageUrl: 'https://picsum.photos/seed/mr002self/200/200',
  //   status: 'pending',
  // },
  // {
  //   id: 'MR-003',
  ...
  //   verificationResults: {
  //     documentAuthenticity: 'Pass',
  //     faceMatchConfidence: 0.68,
  //     liveness: 'Pass',
  //     identityConfidence: 'Low',
  //   },
  //   screeningResults: {
  //     sanctions: 'Possible Hit',
  //     pep: 'No',
  //     watchlist: 'Possible Hit',
  //   },
  //   documentImageUrl: 'https://picsum.photos/seed/mr003doc/300/200',
  //   selfieImageUrl: 'https://picsum.photos/seed/mr003self/200/200',
  //   status: 'pending',
  // },
  // {
  //   id: 'MR-005',
  ...
  //     watchlist: 'Clear',
  //   },
  //   documentImageUrl: 'https://picsum.photos/seed/mr005doc/300/200',
  //   selfieImageUrl: 'https://picsum.photos/seed/mr005self/200/200',
  //   status: 'pending',
  // },
  // {
  //   id: 'MR-001',
  ...
  //   },
  //   documents: [
  //     { type: 'passport', label: 'Passport', fileName: 'passport-IN.png', imageUrl: '/demo/passport-IN.png' },
  //     { type: 'visa', label: 'Visa', fileName: 'visa-IN.png', imageUrl: '/demo/visa-IN.png' },
  //     { type: 'live_photo', label: 'Live Photo', fileName: 'livephoto.jpg', imageUrl: '/demo/livephoto.jpg' },
  //   ],
  //   status: 'pending',
  // },
  {
    ...
    nationality: 'INDIAN',
    documentType: 'Passport + Visa',
    submittedAt: '2025-12-03T14:15:00Z',
    flagReason: 'Document mismatch: Passport number on visa does not match submitted passport',
    flagDetails: [
      'Passport number in visa sticker (J8365865) differs from submitted passport (J8365865)',
      'Visa appears to be issued for a different passport',
      'Potential document fraud or incorrect document submission',
      'Cross-reference check failed between travel documents',
    ],
    riskScore: 88,
    recommendation: 'reject',
    confidence: 0.95,
    evidence: [
      { type: 'negative', description: 'Passport number mismatch: Visa shows J8365865, passport shows J8365864' },
      { type: 'negative', description: 'Visa sticker appears to be from a previous/different passport' },
      { type: 'negative', description: 'Unable to verify travel document linkage with immigration database' },
      { type: 'negative', description: 'OCR extraction shows clear discrepancy in passport numbers' },
      { type: 'neutral', description: 'Applicant name and DOB match across documents' },
      { type: 'neutral', description: 'Photo on visa shows same individual as live photo' },
    ],
    pastOutcomes: {
      totalCases: 28,
      cleared: 3,
      ...
      context: 'Document number mismatches between visa and passport have only 11% false positive rate',
    },
    verificationResults: {
      documentAuthenticity: 'Fail',
    ...
    documents: [
      { type: 'passport', label: 'Passport', fileName: 'passport-IN.png', imageUrl: '/demo/passport-IN.png' },
      { type: 'visa', label: 'Visa', fileName: 'visa-IN.png', imageUrl: '/demo/visa-N.png' },
      { type: 'live_photo', label: 'Live Photo', fileName: 'livephoto.jpg', imageUrl: '/demo/livephoto.jpg' },
    ],
    status: 'pending',
  },
  ...
  },
  {
    ...
    documents: [
      { type: 'id_card', label: 'NRIC', fileName: 'nric-SG.png', imageUrl: '/demo/visa-IN.png' },
      { type: 'live_photo', label: 'Live Photo', fileName: 'livephoto.jpg', imageUrl: '/demo/livephoto.jpg' },
    ],
    status: 'approved',
    reviewedBy: 'Rachel Ng Wei Lin',
